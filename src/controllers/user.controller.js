...
const getWatchHistory = asyncHandler(async(req,res)=>{
    const user=await User.aggregate([
        {
            $match:{
                _id:new mongoose.Types.ObjectId(req.user._id)   //we want id as whole ObjectId("kegfawjcawkjlgaw") 
            }    //but req.user just gives us string "awljchalkcla" and mongoose converts it into original form but
        },  // in aggregate mongoose dont convert it into it so we used new mongoose.types
        {
            $lookup:{
                from:"videos",
